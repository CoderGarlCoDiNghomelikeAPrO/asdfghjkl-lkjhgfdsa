...
new_height=screen.height-300;
    ...
    if(width<992)
    {
        document.getElementById("myCanavs").width=new_width;    
        document.getElementById("myCanavs").width=new_height;
    ...
    function my_mousedown(e)
    {
        ...
        SVGSymbolElement.log("x = "+ current_postition_of_touch_x+"y ="+ current_postioton_of_touch_y)
